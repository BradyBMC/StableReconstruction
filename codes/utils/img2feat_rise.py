...
def main():
    ...
    os.makedirs(f'../../nsdfeat/rise_latent/', exist_ok=True)
    os.makedirs(f'../../nsdfeat/rise_c/', exist_ok=True)
    ...
    for s in tqdm(range(itr)):
        ...
        np.save(f'../../nsdfeat/rise_latent/{s:06}.npy',init_latent)
        np.save(f'../../nsdfeat/rise_c/{s:06}.npy',c)
